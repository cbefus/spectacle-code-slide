...
var CodeSlide = function (_React$Component) {
  ...
  _createClass(CodeSlide, [{
    ...
    value: function renderDownArrow() {
      return React.createElement(
        'button',
        {
          ...
          style: 'position: absolute; top: 90%; left: 50%; z-index: 9999; background: none; border: none; outline: 0px;'
        },
        React.createElement(
          'svg',
          {
            ...
            role: 'presentation',
            focusable: 'false',
            style: 'fill: rgb(255, 102, 0); transition: fill 1s ease-in-out 0.2s; transform: rotate(90deg);'
          },
    ...
    key: 'renderUpArrow',
    value: function renderUpArrow() {
      return React.createElement(
        'button',
        {
          type: 'button',
          'aria-label': 'Slide Up',
          style: 'position: absolute; top: 5%; left: 50%; z-index: 9999; background: none; border: none; outline: 0px;'
        },
        React.createElement(
          'svg',
          {
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          width = _props2.width,
          rest = _objectWithoutProperties(_props2, ['code', 'lang', 'ranges', 'color', 'bgColor', 'titleStyle', 'showLineNumbers', 'width']);
